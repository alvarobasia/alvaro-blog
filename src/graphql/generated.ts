...
export type PostManyWhereInput = {
  ...
  /** All values greater than the given value. */
  likes_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  likes_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  likes_in?: InputMaybe<Array<Scalars['Int']>>;
  /** All values less than the given value. */
  likes_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  likes_lte?: InputMaybe<Scalars['Int']>;
  /** All values that are not equal to given value. */
  likes_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  likes_not_in?: InputMaybe<Array<Scalars['Int']>>;
  publishedAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export type GetPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, likes: number, date: any, slug: string, excerpt?: string | null, title: string, tags: Array<string>, author?: { __typename?: 'Author', name: string } | null }> };
